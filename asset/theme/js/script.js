...
(function() {
    ...
    function p(a) {
        (function f() {
            0 > (a.style.opacity -= .1) ? a.style.display = "none" : requestAnimationFrame(f)
        }
        )()
    }
    function t(a) {
    ...
    function x(a, b, f) {
        ...
        e.contains("row") && (e.remove("row"),
        e.add("media-container-row"));
    ...
    Element.prototype.parents = function(a) {
        for (var b = [], f = this, g = void 0 !== a; null !== (f = f.parentElement); )
    ...
    Element.prototype.footerReveal = function() {
        function a() {
            !f && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999",
            this.style.position = "fixed",
            this.style.bottom = "0",
            this.style.width = b.offsetWidth,
            b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "",
            this.style.position = "",
            this.style.bottom = "",
            this.style.width = "",
    ...
    l(function() {
            ...
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (b) {
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                        ...
                        m && (e.style.backgroundImage = 'url("images/video-placeholder.jpg")',
                        e.style.display = "block")
                }
            })
        }
        ...
        window.addEventListener("scroll", function() {
            ...
            if (q) {
                ...
                b ? c != q.fixed && (l ? (q.fixed = c,
                q.elm.classList.toggle("is-fixed")) : e = setTimeout(function() {
                    q.fixed = c;
                    q.elm.classList.toggle("is-fixed")
                }, 40)) : (q.fixed = !1,
                q.elm.classList.remove("is-fixed"))
            }
        });
        if (r)
                ...
                var a = function() {
                    ...
                    g.forEach(function(e) {
                        var f = e.offsetHeight
                          , g = d(e);
                        (g + f >= a && g - 50 <= c || b(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"),
    ...
    document.body.querySelectorAll(".clients").forEach(function(a) {
        a.getAttribute("data-isinit") || (z(a),
        D(a))
    })),
    ...
    if (m) {
        if (!r)
            return;
        h(document).on("add.cards", function(a) {
            h(a.target).find(".form-with-styler").length && (a = h(a.target).find(".form-with-styler"),
            h(a).find('select:not("[multiple]")').each(function() {
